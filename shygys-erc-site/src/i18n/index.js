...
const messages = {
  ...
  kz: {
    ...
    aboutCompanyTitle: 'KZ О компании',
    aboutCompanyText:
      'KZ ТОО «ЕРЦ Шығыс» оказывает услуги по обработке, формированию и доставке единого платежного документа. Менеджер ТОО "ЕРЦ Шығыс" осуществляет прием показаний по индивидуальным приборам учета горячей воды по адресу ул. М. Горького, 61.',
    functionsCompanyTitle: 'KZ Функции компании',
    functionsCompanyText:
      'KZ • обработка и формирование ЕПД с соблюдением требований, действующих нормативных правовых актов, включая размещение информации о начислениях за услуги Вашей организации наравне с другими коммунальными предприятиями города;\n• доставка (разноска) ЕПД до каждого потребителя;\n• предоставление отчетности о проделанной работе;\n• предоставление потребителям возможности оплаты ЕПД через платежные терминалы и банки второго уровня;\n• оперативная отработка поступающих предложений.\n\n ТОО «ЕРЦ Шығыс» осуществляет свою деятельность на территории г. Усть-Каменогорск.',
    contactsCompanyTitle: 'KZ Контакты',
    contactsCompanyText:
      'KZ На территории здания управления АО «Шығыс Жылу», расположенного по адресу г. Усть-Каменогорск, ул. М. Горького, 61, менеджер организации осуществляет прием потребителей по вопросам ЕПД.\n\nКонтактный телефон 701 – 234',
